...
const {newProduct, products, prodname, prodImage, deleteProd,updateProd, firstImage}=require('../controllers/productController')
const authentication=require('../middleware/auth')
router.post('/newProduct',authentication.admin,formidable({multiples:true}),newProduct)
